...
class CheckCommand(BaseCommand):
   def __init__(self, discord_client, mention, permission_checker, check_players_task):
      self.check_players_task = check_players_task
      super(CheckCommand, self).__init__(discord_client, mention, permission_checker)
